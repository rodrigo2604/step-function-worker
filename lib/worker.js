...
function Worker(options) {
  ...
  this.autoStart =
    typeof options.autoStart === 'boolean' ? options.autoStart : true;
...
Worker.prototype.execute = function(taskInput, cb, heartbeat) {
  this.fn(taskInput, cb, heartbeat);
};
